    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Price (BDT/month) *</label>
            <input
              name="price"
              type="number"
              value={form.price}
    ...
    <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 mt-4">
      {imageUrls.map((url, index) => (
        ...
        <button
          ...
          className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white rounded-md py-3 text-sm font-medium transition"
        >
