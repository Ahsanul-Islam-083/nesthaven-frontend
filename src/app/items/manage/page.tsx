    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">View, and delete the properties you&apos;ve listed.</p>
        </div>
        <Link
          href="/items/add"
          className="bg-teal-700 hover:bg-teal-800 text-white rounded-md px-4 py-2 text-sm font-medium transition whitespace-nowrap"
        >
          + Add New
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white border border-slate-200 rounded-xl">
          ...
          <Link href="/items/add" className="text-teal-700 font-medium hover:underline">
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
          ...
          {properties.map((property) => (
            <div
              key={property._id}
              className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center px-6 py-4 border-t border-slate-100"
            >
              ...
              <div className="sm:col-span-2 text-sm text-slate-600">{property.type}</div>
              ...
              <div className="sm:col-span-3 flex justify-start sm:justify-end gap-2">
                <Link
                  ...
                  className="text-sm bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md px-3 py-1.5 transition"
                >
                  View
                </Link>
                <button
                  ...
                  className="text-sm bg-red-50 hover:bg-red-100 text-red-600 rounded-md px-3 py-1.5 transition disabled:opacity-50"
                >
